...
def evaluate_validation(path, epoch, prefix, retrain_l, retrain_r, infer_l, infer_r, stream_l, stream_r, postfix, val, ** _):
    if val:
        ...
        with open(f'configs/cache/{prefix}_{postfix}.pkl', 'wb') as f:
            pickle.dump({"data": m, "classwise_data": m_class}, f)
