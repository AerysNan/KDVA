...
def test(config, checkpoint, out, dataset, work_dir=None, fuse_conv_bn=False, format_only=False, eval=None, show=False, show_dir=None, show_score_thr=0.3, gpu_collect=False, tmpdir=None, cfg_options=None, eval_options=None, launcher='none', **_):
    ...
    if fuse_conv_bn:
        model = mmcv.cnn.fuse_conv_bn(model)
