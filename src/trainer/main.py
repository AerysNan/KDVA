...
if __name__ == '__main__':
    ...
    parser.add_argument('--emulation-config', '-e', type=str, help='emulation configuration file', default=None)
    parser.add_argument('--device', '-d', type=str, help='device', default='cuda:0')
    parser.add_argument('--port', '-p', type=str, default='8089', help='listening port for trainer')
