...
do
  ...
  CUDA_VISIBLE_DEVICES=${DEVICE} python3 tools/model_test.py configs/custom/ssd_base.py tmp_merge_${PREFIX}_${stream}m$4$5_${POSTFIX}_${CONFIG}/latest.pth --out tmp_merge_${PREFIX}_${stream}m$4$5_${POSTFIX}_${CONFIG}/$(printf %02d 0).pkl -d ${PREFIX}_${stream}_test_0
done
...
do
  ...
  for stream in $4 $5
  do
    CUDA_VISIBLE_DEVICES=${DEVICE} python3 tools/model_test.py configs/custom/ssd_base.py tmp_merge_${PREFIX}_${stream}m$4$5_${POSTFIX}_${CONFIG}/latest.pth --out tmp_merge_${PREFIX}_${stream}m$4$5_${POSTFIX}_${CONFIG}/$(printf %02d ${i}).pkl -d ${PREFIX}_${stream}_test_${i}
  done
done
